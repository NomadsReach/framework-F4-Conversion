...
class PrismaUIInterface : public PRISMA_UI_API::IVPrismaUI4 {
public:
    static PrismaUIInterface* GetSingleton()
    {
        static PrismaUIInterface instance;
        return &instance;
    }

    PrismaView CreateView(const char* htmlPath, PRISMA_UI_API::OnDomReadyCallback onDomReadyCallback) noexcept override;
    void Invoke(PrismaView view, const char* script, PRISMA_UI_API::JSCallback callback) noexcept override;
    ...
    void SetInspectorBounds(PrismaView view, float topLeftX, float topLeftY,
                            unsigned int width, unsigned int height) noexcept override;
    ...
    void RegisterTranslations(PrismaView view, const char* pluginName) noexcept override;
    void BindUIEvent(PrismaView view, const char* functionName,
                     PRISMA_UI_API::JSListenerCallback callback) noexcept override;
    void EnumerateViews(PRISMA_UI_API::ViewEnumCallback callback, void* userdata) noexcept override;

private:
    PrismaUIInterface() = default;
};
