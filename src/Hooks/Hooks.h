...
struct D3DHooks {
    ...
    static HRESULT APIENTRY HookPresent(REX::W32::IDXGISwapChain* swapChain, UINT syncInterval, UINT flags);
    static HRESULT APIENTRY HookResizeBuffers(REX::W32::IDXGISwapChain* swapChain, UINT bufferCount, UINT width,
